...
#+begin_src emacs-lisp :tangle yes
  (setq org-blank-before-new-entry (quote ((heading)
                                           (plain-list-item))))
#+end_src
** DONE Org mode display image files
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-link-abbrev-alist
        '(("bib" . "~usb/Documents/Work/Articles/generalOcular.bib::%s")
          ("notes" . "~usb/Documents/Work/Articles/generalOcular.org::#%s")
          ("pdf" . "~usb/Documents/Work/Articles/PDF/%s.pdf")))
  
#+END_SRC

#+results:
| (bib . ~usb/Documents/Work/Articles/generalOcular.bib::%s) | (notes . ~usb/Documents/Work/Articles/generalOcular.org::#%s) | (pdf . ~usb/Documents/Work/Articles/PDF/%s.pdf) |
